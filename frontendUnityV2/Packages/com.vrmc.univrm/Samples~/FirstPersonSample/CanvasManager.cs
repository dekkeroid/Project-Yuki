...
namespace VRM.FirstPersonSample
{
    public class CanvasManager : MonoBehaviour
    {
        ...
        private void Reset()
        {
            ...
            LoadVRMButton = GameObject.FindObjectsByType<Button>().FirstOrDefault(x => x.name == "LoadVRM");
            LoadBVHButton = GameObject.FindObjectsByType<Button>().FirstOrDefault(x => x.name == "LoadBVH");
#else
