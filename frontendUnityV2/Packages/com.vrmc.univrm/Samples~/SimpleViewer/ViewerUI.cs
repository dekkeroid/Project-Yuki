...
namespace VRM.SimpleViewer
{
    ...
    public class ViewerUI : MonoBehaviour
    {
        ...
        private void Reset()
        {
            ...
            var buttons = GameObject.FindObjectsByType<Button>();
#else
...
#if UNITY_2022_3_OR_NEWER
            var toggles = GameObject.FindObjectsByType<Toggle>();
#else
...
#if UNITY_2022_3_OR_NEWER
            var texts = GameObject.FindObjectsByType<Text>();
#else
...
#if UNITY_2022_3_OR_NEWER
            m_src = GameObject.FindAnyObjectByType<HumanPoseTransfer>();

            m_target = GameObject.FindAnyObjectByType<TargetMover>().gameObject;
#else
