...
namespace Yuki.UnityFrontend.UI
{
    public sealed class YukiUIController : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            {
                // Sync audio manager amplitude to avatar for lip sync
        ...
        private void UpdateDropdownSelections(YukiProfileSettings settings)
        {
            ...
            // Simple helpers to select correct dropdown option
        ...
        {
            // Reset bubble context if it was closed
        ...
        private void HandleAudioChunk(string audioUrlBase64, string speechText)
        {
            ...
            {
                // In React, raw text formatting is cleaned for TTS. We store clean text for subtitles.
        ...
        private void OnSpeechStarted(string text)
        {
            ...
            // Sync facial expressions if text contains keywords
            if (avatarPresenter != null)
            {
        ...
        {
            // Close bubble after speech ends
        ...
        private async void SubmitUserChat()
        {
            ...
            // Clean suggestions overlay
            if (suggestionsContainer != null) suggestionsContainer.SetActive(false);

            // Interrupt any active assistant speech output
        ...
        {
            // Autocomplete check (types '/' commands)
            ...
            // For simplicity, we can fetch suggestions from backend when `/open` or `/play` query is typed
        ...
        {
            // Replicate Electron REST suggestions fetching
            ...
            // Call REST suggestions endpoint (simplified)
            yield return null;
        }
        ...
        private void ToggleMicrophoneInput()
        {
            ...
            // Sync mic buttons graphics and toggle backend STT
        }
