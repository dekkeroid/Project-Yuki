    ...
    public sealed class YukiAudioPlaybackManager : MonoBehaviour
    {
        ...
        private void Update()
        {
            if (audioSource != null && audioSource.isPlaying)
            {
                ...
                // Clamp amplitude to range 0.0 - 1.0 (apply scaling factor to make it visualizable)
        ...
        private void ProcessQueue()
        {
            ...
            // Trigger speech ended event when normal audio finishes
            ...
            // If we are currently simulating mute wait duration, yield queue processing
        ...
        public void SetMuted(bool muted)
        {
            ...
            {
                // Transition active speech to simulated delay
