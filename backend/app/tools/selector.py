...
_QUERY_EXPANSIONS = {
    ...
    "picture": ("image", "photo", "graphics", "draw"),
...
_TOOL_HINTS = {
    ...
    "jarvis_html_graphics": ("graphics", "draw", "drawing", "pixel", "pixelart", "svg", "canvas", "diagram", "flowchart", "architecture", "uml", "wireframe", "graph", "schema", "visual", "card", "banner", "sprite", "8bit", "paint", "sketch", "illustration"),
