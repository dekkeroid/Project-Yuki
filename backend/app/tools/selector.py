...
_TOOL_HINTS = {
    ...
    "jarvis_keyboard_mouse_input": ("keyboard", "mouse", "type", "press", "key", "shortcut", "click", "scroll", "move", "drag", "cursor", "coordinate", "coordinates", "position"),
    ...
    "keyboard_mouse_input": ("keyboard", "mouse", "type", "click", "press", "scroll", "move", "drag", "cursor", "coordinate", "coordinates", "position"),
