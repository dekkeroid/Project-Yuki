...
_QUERY_EXPANSIONS = {
    ...
    "art": ("image", "picture", "artwork", "draw", "paint", "illustration"),
    ...
    "flowchart": ("svg", "diagram", "process", "visual", "workflow"),
    "flux": ("image", "generate", "diffusion", "art", "picture"),
    "folder": ("directory", "file", "open", "list", "search"),
    "google": ("web", "internet", "search"),
    "illustration": ("image", "draw", "art", "picture", "generate"),
    "imagen": ("image", "generate", "diffusion", "art", "picture"),
    ...
    "paint": ("draw", "image", "picture", "artwork", "generate"),
    "photo": ("image", "picture", "photograph", "generate"),
    "photograph": ("image", "photo", "picture", "generate"),
    "picture": ("image", "photo", "art", "draw", "generate"),
    "pixel": ("art", "svg", "canvas", "sprite", "diagram"),
    "play": ("media", "audio", "video", "file"),
    "portrait": ("image", "picture", "photo", "drawing", "generate"),
    "pull": ("open", "launch", "show"),
    "run": ("execute", "terminal", "command", "script"),
    "search": ("find", "lookup", "web", "file"),
    "serve": ("html", "file", "local", "open"),
    "sketch": ("draw", "image", "picture", "drawing", "illustration"),
    ...
    "wallpaper": ("image", "picture", "scenery", "background", "generate"),
    "watch": ("stopwatch", "video", "media", "play", "open"),
    "web": ("internet", "search", "browse"),
    "website": ("html", "page", "dashboard"),
    "wireframe": ("diagram", "architecture", "svg", "schema"),
}
...
_TOOL_HINTS = {
    ...
    "jarvis_generate_image": ("generate_image", "draw", "generate", "image", "picture", "photo", "wallpaper", "portrait", "scenery", "drawing", "artwork", "photograph", "paint", "diffusion", "flux", "imagen"),
    "jarvis_see_screen": ("screen", "look", "see", "watch", "display", "view", "monitor", "desktop", "window", "current"),
    "jarvis_html_graphics": ("diagram", "flowchart", "architecture", "svg", "uml", "wireframe", "graph", "schema", "state_machine", "vector", "animat", "canvas_diagram"),
