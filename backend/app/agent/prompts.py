...
AVAILABLE_AVATAR_ANIMATIONS = [
    ...
    {"name": "formal_bow", "tag": "bow", "desc": "Polite Japanese bow for greetings, showing respect, or everyday polite apologies"},
    {"name": "dogeza_bow", "tag": "dogeza", "desc": "Deep floor dogeza bow — ultimate apology for admitting a big blunder, major regret, or making a desperate request"},
