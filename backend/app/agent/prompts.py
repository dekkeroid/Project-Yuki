...
AVAILABLE_AVATAR_ANIMATIONS = [
    ...
    {"name": "formal_bow", "tag": "bow", "desc": "Polite Japanese bow / formal greeting & respect bow"},
...
------------------------------------------"""
    ...
    cue_map = {
        ...
        "bow": "Polite Japanese greeting, formal bow, or courteous respect -> `<yuki_anim:bow/>`",
